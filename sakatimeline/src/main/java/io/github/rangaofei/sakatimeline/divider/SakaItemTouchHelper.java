...
public class SakaItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    public SakaItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
     ...
     * {@link SakaItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link SakaItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see SakaItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link SakaItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link SakaItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
    ...
    public abstract static class Callback {
         ...
         *                    it is cleared.
         * @param actionState One of {@link SakaItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link SakaItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link SakaItemTouchHelper#ACTION_STATE_DRAG}.
        ...
        void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected,
                    List<SakaItemTouchHelper.RecoverAnimation> recoverAnimationList,
                    int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final SakaItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
